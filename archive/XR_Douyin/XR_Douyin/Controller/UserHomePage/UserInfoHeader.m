...
- (void)onTapAction:(UIGestureRecognizer *)sender {
...
- (void)overScrollAction:(CGFloat) offsetY {
    ...
    _avatarBackground.transform = CGAffineTransformConcat(CGAffineTransformMakeScale(1.0 + scaleRatio, 1.0 + scaleRatio), CGAffineTransformMakeTranslation(0, -fabs(offsetY)/2));
}
